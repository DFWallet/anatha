...
* [\#4486](https://github.com/DFWallet/anatha/issues/4486) Introduce new `PeriodicVestingAccount` vesting account type
...
* (rest) [\#4924](https://github.com/DFWallet/anatha/pull/4924) Return response
...
* [\#3928](https://github.com/DFWallet/anatha/issues/3928) remove staking references from types package
...
* [\#4230](https://github.com/DFWallet/anatha/issues/4230) Properly set and display the message index through the TxResponse.
...
* SDK
  ...
  * [staking] [\#3289](https://github.com/DFWallet/anatha/issues/3289) misc renames:
    * `Validator.UnbondingMinTime` -> `Validator.UnbondingCompletionTime`
    * `Delegation` -> `Value` in `MsgCreateValidator` and `MsgDelegate`
    * `MsgBeginUnbonding` -> `MsgUndelegate`
...
* Gaia
  * [\#2772](https://github.com/DFWallet/anatha/issues/2772) Update BaseApp to not persist state when the ante handler fails on DeliverTx.
  * [\#2773](https://github.com/DFWallet/anatha/issues/2773) Require moniker to be provided on `gaiad init`.
  * [\#2672](https://github.com/DFWallet/anatha/issues/2672) [Makefile] Updated for better Windows compatibility and ledger support logic, get_tools was rewritten as a cross-compatible Makefile.
  * [\#2766](https://github.com/DFWallet/anatha/issues/2766) [Makefile] Added goimports tool to get_tools. Get_tools now only builds new versions if binaries are missing.
  * [#110](https://github.com/tendermint/devops/issues/110) Updated CircleCI job to trigger website build when cosmos docs are updated.

* SDK
 & [x/mock/simulation] [\#2720] major cleanup, introduction of helper objects, reorganization
 * [\#2821](https://github.com/DFWallet/anatha/issues/2821) Codespaces are now strings
 * [types] [\#2776](https://github.com/DFWallet/anatha/issues/2776) Improve safety of `Coin` and `Coins` types. Various functions
 and methods will panic when a negative amount is discovered.
 * [\#2815](https://github.com/DFWallet/anatha/issues/2815) Gas unit fields changed from `int64` to `uint64`.
 * [\#2821](https://github.com/DFWallet/anatha/issues/2821) Codespaces are now strings
 * [\#2779](https://github.com/DFWallet/anatha/issues/2779) Introduce `ValidateBasic` to the `Tx` interface and call it in the ante
 handler.
 * [\#2825](https://github.com/DFWallet/anatha/issues/2825) More staking and distribution invariants
 * [\#2912](https://github.com/DFWallet/anatha/issues/2912) Print commit ID in hex when commit is synced.

* Tendermint
 * [\#2796](https://github.com/DFWallet/anatha/issues/2796) Update to go-amino 0.14.1


BUG FIXES

* Gaia REST API (`gaiacli advanced rest-server`)
  * [gaia-lite] [\#2868](https://github.com/DFWallet/anatha/issues/2868) Added handler for governance tally endpoint
  * [\#2907](https://github.com/DFWallet/anatha/issues/2907) Refactor and fix the way Gaia Lite is started.

* Gaia
  * [\#2723] Use `cosmosvalcons` Bech32 prefix in `tendermint show-address`
  * [\#2742](https://github.com/DFWallet/anatha/issues/2742) Fix time format of TimeoutCommit override
  * [\#2898](https://github.com/DFWallet/anatha/issues/2898) Remove redundant '$' in docker-compose.yml

* SDK
  * [\#2733](https://github.com/DFWallet/anatha/issues/2733) [x/gov, x/mock/simulation] Fix governance simulation, update x/gov import/export
  * [\#2854](https://github.com/DFWallet/anatha/issues/2854) [x/bank] Remove unused bank.MsgIssue, prevent possible panic
  * [\#2884](https://github.com/DFWallet/anatha/issues/2884) [docs/examples] Fix `basecli version` panic
...
* Gaia
  * [gaiad init] [\#2602](https://github.com/DFWallet/anatha/issues/2602) New genesis workflow

* SDK
  * [simulation] [\#2665](https://github.com/DFWallet/anatha/issues/2665) only argument to sdk.Invariant is now app
...
* Gaia CLI  (`gaiacli`)
  * [cli] [\#2569](https://github.com/DFWallet/anatha/pull/2569) Add commands to query validator unbondings and redelegations
  * [cli] [\#2569](https://github.com/DFWallet/anatha/pull/2569) Add commands to query validator unbondings and redelegations
  * [cli] [\#2524](https://github.com/DFWallet/anatha/issues/2524) Add support offline mode to `gaiacli tx sign`. Lookups are not performed if the flag `--offline` is on.
  * [cli] [\#2558](https://github.com/DFWallet/anatha/issues/2558) Rename --print-sigs to --validate-signatures. It now performs a complete set of sanity checks and reports to the user. Also added --print-signature-only to print the signature only, not the whole transaction.
  * [cli] [\#2704](https://github.com/DFWallet/anatha/pull/2704) New add-genesis-account convenience command to populate genesis.json with genesis accounts.

* SDK
  * [\#1336](https://github.com/DFWallet/anatha/issues/1336) Mechanism for SDK Users to configure their own Bech32 prefixes instead of using the default cosmos prefixes.

IMPROVEMENTS

* Gaia
 * [\#2637](https://github.com/DFWallet/anatha/issues/2637) [x/gov] Switched inactive and active proposal queues to an iterator based queue

* SDK
 * [\#2573](https://github.com/DFWallet/anatha/issues/2573) [x/distribution] add accum invariance
 * [\#2556](https://github.com/DFWallet/anatha/issues/2556) [x/mock/simulation] Fix debugging output
 * [\#2396](https://github.com/DFWallet/anatha/issues/2396) [x/mock/simulation] Change parameters to get more slashes
 * [\#2617](https://github.com/DFWallet/anatha/issues/2617) [x/mock/simulation] Randomize all genesis parameters
 * [\#2669](https://github.com/DFWallet/anatha/issues/2669) [x/stake] Added invarant check to make sure validator's power aligns with its spot in the power store.
 * [\#1924](https://github.com/DFWallet/anatha/issues/1924) [x/mock/simulation] Use a transition matrix for block size
 * [\#2660](https://github.com/DFWallet/anatha/issues/2660) [x/mock/simulation] Staking transactions get tested far more frequently
 * [\#2610](https://github.com/DFWallet/anatha/issues/2610) [x/stake] Block redelegation to and from the same validator
 * [\#2652](https://github.com/DFWallet/anatha/issues/2652) [x/auth] Add benchmark for get and set account
 * [\#2685](https://github.com/DFWallet/anatha/issues/2685) [store] Add general merkle absence proof (also for empty substores)
 * [\#2708](https://github.com/DFWallet/anatha/issues/2708) [store] Disallow setting nil values

BUG FIXES

* Gaia
 * [\#2670](https://github.com/DFWallet/anatha/issues/2670) [x/stake] fixed incorrect `IterateBondedValidators` and split into two functions: `IterateBondedValidators` and `IterateLastBlockConsValidators`
 * [\#2691](https://github.com/DFWallet/anatha/issues/2691) Fix local testnet creation by using a single canonical genesis time
 * [\#2648](https://github.com/DFWallet/anatha/issues/2648) [gaiad] Fix `gaiad export` / `gaiad import` consistency, test in CI

* SDK
 * [\#2625](https://github.com/DFWallet/anatha/issues/2625) [x/gov] fix AppendTag function usage error
 * [\#2677](https://github.com/DFWallet/anatha/issues/2677) [x/stake, x/distribution] various staking/distribution fixes as found by the simulator
 * [\#2674](https://github.com/DFWallet/anatha/issues/2674) [types] Fix coin.IsLT() impl, coins.IsLT() impl, and renamed coins.Is\* to coins.IsAll\* (see [\#2686](https://github.com/DFWallet/anatha/issues/2686))
 * [\#2711](https://github.com/DFWallet/anatha/issues/2711) [x/stake] Add commission data to `MsgCreateValidator` signature bytes.
...
* Gaia REST API (`gaiacli advanced rest-server`)
    ...
    * [\#595](https://github.com/DFWallet/anatha/issues/595) Connections to the REST server are now secured using Transport Layer Security by default. The --insecure flag is provided to switch back to insecure HTTP.
    * [gaia-lite] [\#2258](https://github.com/DFWallet/anatha/issues/2258) Split `GET stake/delegators/{delegatorAddr}` into `GET stake/delegators/{delegatorAddr}/delegations`, `GET stake/delegators/{delegatorAddr}/unbonding_delegations` and `GET stake/delegators/{delegatorAddr}/redelegations`

* Gaia CLI  (`gaiacli`)
    * [x/stake] Validator.Owner renamed to Validator.Operator
    * [cli] unsafe_reset_all, show_validator, and show_node_id have been renamed to unsafe-reset-all, show-validator, and show-node-id
    * [cli] [\#1983](https://github.com/DFWallet/anatha/issues/1983) --print-response now defaults to true in commands that create and send a transaction
    * [cli] [\#1983](https://github.com/DFWallet/anatha/issues/1983) you can now pass --pubkey or --address to gaiacli keys show to return a plaintext representation of the key's address or public key for use with other commands
    * [cli] [\#2061](https://github.com/DFWallet/anatha/issues/2061) changed proposalID in governance REST endpoints to proposal-id
    * [cli] [\#2014](https://github.com/DFWallet/anatha/issues/2014) `gaiacli advanced` no longer exists - to access `ibc`, `rest-server`, and `validator-set` commands use `gaiacli ibc`, `gaiacli rest-server`, and `gaiacli tendermint`, respectively
    * [makefile] `get_vendor_deps` no longer updates lock file it just updates vendor directory. Use `update_vendor_deps` to update the lock file. [#2152](https://github.com/DFWallet/anatha/pull/2152)
    * [cli] [\#2221](https://github.com/DFWallet/anatha/issues/2221) All commands that
    utilize a validator's operator address must now use the new Bech32 prefix,
    `cosmosvaloper`.
    * [cli] [\#2190](https://github.com/DFWallet/anatha/issues/2190) `gaiacli init --gen-txs` is now `gaiacli init --with-txs` to reduce confusion
    * [cli] [\#2073](https://github.com/DFWallet/anatha/issues/2073) --from can now be either an address or a key name
    * [cli] [\#1184](https://github.com/DFWallet/anatha/issues/1184) Subcommands reorganisation, see [\#2390](https://github.com/DFWallet/anatha/pull/2390) for a comprehensive list of changes.
    * [cli] [\#2524](https://github.com/DFWallet/anatha/issues/2524) Add support offline mode to `gaiacli tx sign`. Lookups are not performed if the flag `--offline` is on.
    * [cli] [\#2570](https://github.com/DFWallet/anatha/pull/2570) Add commands to query deposits on proposals

* Gaia
    * Make the transient store key use a distinct store key. [#2013](https://github.com/DFWallet/anatha/pull/2013)
    * [x/stake] [\#1901](https://github.com/DFWallet/anatha/issues/1901) Validator type's Owner field renamed to Operator; Validator's GetOwner() renamed accordingly to comply with the SDK's Validator interface.
    * [docs] [#2001](https://github.com/DFWallet/anatha/pull/2001) Update slashing spec for slashing period
    * [x/stake, x/slashing] [#1305](https://github.com/DFWallet/anatha/issues/1305) - Rename "revoked" to "jailed"
    * [x/stake] [#1676] Revoked and jailed validators put into the unbonding state
    * [x/stake] [#1877] Redelegations/unbonding-delegation from unbonding validator have reduced time
    * [x/slashing] [\#1789](https://github.com/DFWallet/anatha/issues/1789) Slashing changes for Tendermint validator set offset (NextValSet)
    * [x/stake] [\#2040](https://github.com/DFWallet/anatha/issues/2040) Validator
    operator type has now changed to `sdk.ValAddress`
    * [x/stake] [\#2221](https://github.com/DFWallet/anatha/issues/2221) New
    ...
    * [x/stake] [\#2435](https://github.com/DFWallet/anatha/issues/2435) Remove empty bytes from the ValidatorPowerRank store key
    * [x/gov] [\#2195](https://github.com/DFWallet/anatha/issues/2195) Governance uses BFT Time
    * [x/gov] [\#2256](https://github.com/DFWallet/anatha/issues/2256) Removed slashing for governance non-voting validators
    * [simulation] [\#2162](https://github.com/DFWallet/anatha/issues/2162) Added back correct supply invariants
    * [x/slashing] [\#2430](https://github.com/DFWallet/anatha/issues/2430) Simulate more slashes, check if validator is jailed before jailing
    * [x/stake] [\#2393](https://github.com/DFWallet/anatha/issues/2393) Removed `CompleteUnbonding` and `CompleteRedelegation` Msg types, and instead added unbonding/redelegation queues to endblocker
    * [x/mock/simulation] [\#2501](https://github.com/DFWallet/anatha/issues/2501) Simulate transactions & invariants for fee distribution, and fix bugs discovered in the process
    ...
    * [x/stake] [\#1673](https://github.com/DFWallet/anatha/issues/1673) Validators are no longer deleted until they can no longer possibly be slashed
    * [\#1890](https://github.com/DFWallet/anatha/issues/1890) Start chain with initial state + sequence of transactions
...
* SDK
    * [core] [\#2219](https://github.com/DFWallet/anatha/issues/2219) Update to Tendermint 0.24.0
      * Validator set updates delayed by one block
      * BFT timestamp that can safely be used by applications
      * Fixed maximum block size enforcement
    * [core] [\#1807](https://github.com/DFWallet/anatha/issues/1807) Switch from use of rational to decimal
    * [types] [\#1901](https://github.com/DFWallet/anatha/issues/1901) Validator interface's GetOwner() renamed to GetOperator()
    * [x/slashing] [#2122](https://github.com/DFWallet/anatha/pull/2122) - Implement slashing period
    * [types] [\#2119](https://github.com/DFWallet/anatha/issues/2119) Parsed error messages and ABCI log errors to make     them more human readable.
    * [types] [\#2407](https://github.com/DFWallet/anatha/issues/2407) MulInt method added to big decimal in order to improve efficiency of slashing
    * [simulation] Rename TestAndRunTx to Operation [#2153](https://github.com/DFWallet/anatha/pull/2153)
    * [simulation] Remove log and testing.TB from Operation and Invariants, in favor of using errors [\#2282](https://github.com/DFWallet/anatha/issues/2282)
    * [simulation] Remove usage of keys and addrs in the types, in favor of simulation.Account [\#2384](https://github.com/DFWallet/anatha/issues/2384)
    * [tools] Removed gocyclo [#2211](https://github.com/DFWallet/anatha/issues/2211)
    * [baseapp] Remove `SetTxDecoder` in favor of requiring the decoder be set in baseapp initialization. [#1441](https://github.com/DFWallet/anatha/issues/1441)
    * [baseapp] [\#1921](https://github.com/DFWallet/anatha/issues/1921) Add minimumFees field to BaseApp.
    * [store] Change storeInfo within the root multistore to use tmhash instead of ripemd160 [\#2308](https://github.com/DFWallet/anatha/issues/2308)
    * [codec] [\#2324](https://github.com/DFWallet/anatha/issues/2324) All referrences to wire have been renamed to codec. Additionally, wire.NewCodec is now codec.New().
    * [types] [\#2343](https://github.com/DFWallet/anatha/issues/2343) Make sdk.Msg have a names field, to facilitate automatic tagging.
    * [baseapp] [\#2366](https://github.com/DFWallet/anatha/issues/2366) Automatically add action tags to all messages
    * [x/auth] [\#2377](https://github.com/DFWallet/anatha/issues/2377) auth.StdSignMsg -> txbuilder.StdSignMsg
    * [x/staking] [\#2244](https://github.com/DFWallet/anatha/issues/2244) staking now holds a consensus-address-index instead of a consensus-pubkey-index
    * [x/staking] [\#2236](https://github.com/DFWallet/anatha/issues/2236) more distribution hooks for distribution
    * [x/stake] [\#2394](https://github.com/DFWallet/anatha/issues/2394) Split up UpdateValidator into distinct state transitions applied only in EndBlock
    * [x/slashing] [\#2480](https://github.com/DFWallet/anatha/issues/2480) Fix signing info handling bugs & faulty slashing
    * [x/stake] [\#2412](https://github.com/DFWallet/anatha/issues/2412) Added an unbonding validator queue to EndBlock to automatically update validator.Status when finished Unbonding
    * [x/stake] [\#2500](https://github.com/DFWallet/anatha/issues/2500) Block conflicting redelegations until we add an index
    * [x/params] Global Paramstore refactored
    * [types] [\#2506](https://github.com/DFWallet/anatha/issues/2506) sdk.Dec MarshalJSON now marshals as a normal Decimal, with 10 digits of decimal precision
    * [x/stake] [\#2508](https://github.com/DFWallet/anatha/issues/2508) Utilize Tendermint power for validator power key
    * [x/stake] [\#2531](https://github.com/DFWallet/anatha/issues/2531) Remove all inflation logic
    * [x/mint] [\#2531](https://github.com/DFWallet/anatha/issues/2531) Add minting module and inflation logic
    * [x/auth] [\#2540](https://github.com/DFWallet/anatha/issues/2540) Rename `AccountMapper` to `AccountKeeper`.
    * [types] [\#2456](https://github.com/DFWallet/anatha/issues/2456) Renamed msg.Name() and msg.Type() to msg.Type() and msg.Route() respectively
...
* Gaia REST API (`gaiacli advanced rest-server`)
  ...
  * [gaia-lite] [\#2110](https://github.com/DFWallet/anatha/issues/2110) Add support for `simulate=true` requests query argument to endpoints that send txs to run simulations of transactions
  * [gaia-lite] [\#966](https://github.com/DFWallet/anatha/issues/966) Add support for `generate_only=true` query argument to generate offline unsigned transactions
  * [gaia-lite] [\#1953](https://github.com/DFWallet/anatha/issues/1953) Add /sign endpoint to sign transactions generated with `generate_only=true`.
  * [gaia-lite] [\#1954](https://github.com/DFWallet/anatha/issues/1954) Add /broadcast endpoint to broadcast transactions signed by the /sign endpoint.
  * [gaia-lite] [\#2113](https://github.com/DFWallet/anatha/issues/2113) Rename `/accounts/{address}/send` to `/bank/accounts/{address}/transfers`, rename `/accounts/{address}` to `/auth/accounts/{address}`, replace `proposal-id` with `proposalId` in all gov endpoints
  * [gaia-lite] [\#2478](https://github.com/DFWallet/anatha/issues/2478) Add query gov proposal's deposits endpoint
  * [gaia-lite] [\#2477](https://github.com/DFWallet/anatha/issues/2477) Add query validator's outgoing redelegations and unbonding delegations endpoints

* Gaia CLI  (`gaiacli`)
  * [cli] Cmds to query staking pool and params
  * [gov][cli] [\#2062](https://github.com/DFWallet/anatha/issues/2062) added `--proposal` flag to `submit-proposal` that allows a JSON file containing a proposal to be passed in
  * [\#2040](https://github.com/DFWallet/anatha/issues/2040) Add `--bech` to `gaiacli keys show` and respective REST endpoint to
  provide desired Bech32 prefix encoding
  * [cli] [\#2047](https://github.com/DFWallet/anatha/issues/2047) [\#2306](https://github.com/DFWallet/anatha/pull/2306) Passing --gas=simulate triggers a simulation of the tx before the actual execution.
  The gas estimate obtained via the simulation will be used as gas limit in the actual execution.
  * [cli] [\#2047](https://github.com/DFWallet/anatha/issues/2047) The --gas-adjustment flag can be used to adjust the estimate obtained via the simulation triggered by --gas=simulate.
  * [cli] [\#2110](https://github.com/DFWallet/anatha/issues/2110) Add --dry-run flag to perform a simulation of a transaction without broadcasting it. The --gas flag is ignored as gas would be automatically estimated.
  * [cli] [\#2204](https://github.com/DFWallet/anatha/issues/2204) Support generating and broadcasting messages with multiple signatures via command line:
    * [\#966](https://github.com/DFWallet/anatha/issues/966) Add --generate-only flag to build an unsigned transaction and write it to STDOUT.
    * [\#1953](https://github.com/DFWallet/anatha/issues/1953) New `sign` command to sign transactions generated with the --generate-only flag.
    * [\#1954](https://github.com/DFWallet/anatha/issues/1954) New `broadcast` command to broadcast transactions generated offline and signed with the `sign` command.
  * [cli] [\#2220](https://github.com/DFWallet/anatha/issues/2220) Add `gaiacli config` feature to interactively create CLI config files to reduce the number of required flags
  * [stake][cli] [\#1672](https://github.com/DFWallet/anatha/issues/1672) Introduced
  new commission flags for validator commands `create-validator` and `edit-validator`.
  * [stake][cli] [\#1890](https://github.com/DFWallet/anatha/issues/1890) Add `--genesis-format` flag to `gaiacli tx create-validator` to produce transactions in genesis-friendly format.
  * [cli][\#2554](https://github.com/DFWallet/anatha/issues/2554) Make `gaiacli keys show` multisig ready.

* Gaia
  * [cli] [\#2170](https://github.com/DFWallet/anatha/issues/2170) added ability to show the node's address via `gaiad tendermint show-address`
  * [simulation] [\#2313](https://github.com/DFWallet/anatha/issues/2313) Reworked `make test_sim_gaia_slow` to `make test_sim_gaia_full`, now simulates from multiple starting seeds in parallel
  * [cli] [\#1921] (https://github.com/DFWallet/anatha/issues/1921)
    * New configuration file `gaiad.toml` is now created to host Gaia-specific configuration.
    * New --minimum_fees/minimum_fees flag/config option to set a minimum fee.

* SDK
  * [querier] added custom querier functionality, so ABCI query requests can be handled by keepers
  * [simulation] [\#1924](https://github.com/DFWallet/anatha/issues/1924) allow operations to specify future operations
  * [simulation] [\#1924](https://github.com/DFWallet/anatha/issues/1924) Add benchmarking capabilities, with makefile commands "test_sim_gaia_benchmark, test_sim_gaia_profile"
  * [simulation] [\#2349](https://github.com/DFWallet/anatha/issues/2349) Add time-based future scheduled operations to simulator
  * [x/auth] [\#2376](https://github.com/DFWallet/anatha/issues/2376) Remove FeePayer() from StdTx
  * [x/stake] [\#1672](https://github.com/DFWallet/anatha/issues/1672) Implement
...
* Gaia REST API (`gaiacli advanced rest-server`)
    * [x/stake] [\#2000](https://github.com/DFWallet/anatha/issues/2000) Added tests for new staking endpoints
    * [gaia-lite] [\#2445](https://github.com/DFWallet/anatha/issues/2445) Standarized REST error responses
    * [gaia-lite] Added example to Swagger specification for /keys/seed.
    * [x/stake] Refactor REST utils

* Gaia CLI  (`gaiacli`)
    * [cli] [\#2060](https://github.com/DFWallet/anatha/issues/2060) removed `--select` from `block` command
    * [cli] [\#2128](https://github.com/DFWallet/anatha/issues/2128) fixed segfault when exporting directly after `gaiad init`
    * [cli] [\#1255](https://github.com/DFWallet/anatha/issues/1255) open KeyBase in read-only mode
     for query-purpose CLI commands
    * [docs] Added commands for querying governance deposits, votes and tally

* Gaia
    * [x/stake] [#2023](https://github.com/DFWallet/anatha/pull/2023) Terminate iteration loop in `UpdateBondedValidators` and `UpdateBondedValidatorsFull` when the first revoked validator is encountered and perform a sanity check.
    * [x/auth] Signature verification's gas cost now accounts for pubkey type. [#2046](https://github.com/tendermint/tendermint/pull/2046)
    * [x/stake] [x/slashing] Ensure delegation invariants to jailed validators [#1883](https://github.com/DFWallet/anatha/issues/1883).
    * [x/stake] Improve speed of GetValidator, which was shown to be a performance bottleneck. [#2046](https://github.com/tendermint/tendermint/pull/2200)
    * [x/stake] [\#2435](https://github.com/DFWallet/anatha/issues/2435) Improve memory efficiency of getting the various store keys
    * [genesis] [\#2229](https://github.com/DFWallet/anatha/issues/2229) Ensure that there are no duplicate accounts or validators in the genesis state.
    * [genesis] [\#2450](https://github.com/DFWallet/anatha/issues/2450) Validate staking genesis parameters.
    * Add SDK validation to `config.toml` (namely disabling `create_empty_blocks`) [\#1571](https://github.com/DFWallet/anatha/issues/1571)
    * [\#1941](https://github.com/DFWallet/anatha/issues/1941)(https://github.com/DFWallet/anatha/issues/1941) Version is now inferred via `git describe --tags`.
    * [x/distribution] [\#1671](https://github.com/DFWallet/anatha/issues/1671) add distribution types and tests

* SDK
    * [tools] Make get_vendor_deps deletes `.vendor-new` directories, in case scratch files are present.
    * [spec] Added simple piggy bank distribution spec
    * [cli] [\#1632](https://github.com/DFWallet/anatha/issues/1632) Add integration tests to ensure `basecoind init && basecoind` start sequences run successfully for both `democoin` and `basecoin` examples.
    * [store] Speedup IAVL iteration, and consequently everything that requires IAVL iteration. [#2143](https://github.com/DFWallet/anatha/issues/2143)
    * [store] [\#1952](https://github.com/DFWallet/anatha/issues/1952), [\#2281](https://github.com/DFWallet/anatha/issues/2281) Update IAVL dependency to v0.11.0
    * [simulation] Make timestamps randomized [#2153](https://github.com/DFWallet/anatha/pull/2153)
    * [simulation] Make logs not just pure strings, speeding it up by a large factor at greater block heights [\#2282](https://github.com/DFWallet/anatha/issues/2282)
    * [simulation] Add a concept of weighting the operations [\#2303](https://github.com/DFWallet/anatha/issues/2303)
    * [simulation] Logs get written to file if large, and also get printed on panics [\#2285](https://github.com/DFWallet/anatha/issues/2285)
    * [simulation] Bank simulations now makes testing auth configurable [\#2425](https://github.com/DFWallet/anatha/issues/2425)
    * [gaiad] [\#1992](https://github.com/DFWallet/anatha/issues/1992) Add optional flag to `gaiad testnet` to make config directory of daemon (default `gaiad`) and cli (default `gaiacli`) configurable
    * [x/stake] Add stake `Queriers` for Gaia-lite endpoints. This increases the staking endpoints performance by reusing the staking `keeper` logic for queries. [#2249](https://github.com/DFWallet/anatha/pull/2149)
    * [store] [\#2017](https://github.com/DFWallet/anatha/issues/2017) Refactor
    gas iterator gas consumption to only consume gas for iterator creation and `Next`
    calls which includes dynamic consumption of value length.
    * [types/decimal] [\#2378](https://github.com/DFWallet/anatha/issues/2378) - Added truncate functionality to decimal
    * [client] [\#1184](https://github.com/DFWallet/anatha/issues/1184) Remove unused `client/tx/sign.go`.
    * [tools] [\#2464](https://github.com/DFWallet/anatha/issues/2464) Lock binary dependencies to a specific version
    * #2573 [x/distribution] add accum invariance

BUG FIXES

* Gaia CLI  (`gaiacli`)
    * [cli] [\#1997](https://github.com/DFWallet/anatha/issues/1997) Handle panics gracefully when `gaiacli stake {delegation,unbond}` fail to unmarshal delegation.
    * [cli] [\#2265](https://github.com/DFWallet/anatha/issues/2265) Fix JSON formatting of the `gaiacli send` command.
    * [cli] [\#2547](https://github.com/DFWallet/anatha/issues/2547) Mark --to and --amount as required flags for `gaiacli tx send`.

* Gaia
  * [x/stake] Return correct Tendermint validator update set on `EndBlocker` by not
  including non previously bonded validators that have zero power. [#2189](https://github.com/DFWallet/anatha/issues/2189)
  * [docs] Fixed light client section links

* SDK
    * [\#1988](https://github.com/DFWallet/anatha/issues/1988) Make us compile on OpenBSD (disable ledger) [#1988] (https://github.com/DFWallet/anatha/issues/1988)
    * [\#2105](https://github.com/DFWallet/anatha/issues/2105) Fix DB Iterator leak, which may leak a go routine.
    * [ledger] [\#2064](https://github.com/DFWallet/anatha/issues/2064) Fix inability to sign and send transactions via the LCD by
    loading a Ledger device at runtime.
    * [\#2158](https://github.com/DFWallet/anatha/issues/2158) Fix non-deterministic ordering of validator iteration when slashing in `gov EndBlocker`
    * [simulation] [\#1924](https://github.com/DFWallet/anatha/issues/1924) Make simulation stop on SIGTERM
    * [\#2388](https://github.com/DFWallet/anatha/issues/2388) Remove dependency on deprecated tendermint/tmlibs repository.
    * [\#2416](https://github.com/DFWallet/anatha/issues/2416) Refactored `InitializeTestLCD` to properly include proposing validator in genesis state.
...
* Gaia REST API (`gaiacli advanced rest-server`)
  - [x/stake] [\#1880](https://github.com/DFWallet/anatha/issues/1880) More REST-ful endpoints (large refactor)
  - [x/slashing] [\#1866](https://github.com/DFWallet/anatha/issues/1866) `/slashing/signing_info` takes cosmosvalpub instead of cosmosvaladdr
...
* Gaia CLI  (`gaiacli`)
  ...
  -  [x/stake] [\#1828](https://github.com/DFWallet/anatha/issues/1828) Force user to specify amount on create-validator command by removing default
  -  [x/gov] Change `--proposalID` to `--proposal-id`
  -  [x/stake, x/gov] [\#1606](https://github.com/DFWallet/anatha/issues/1606) Use `--from` instead of adhoc flags like `--address-validator`
        and `--proposer` to indicate the sender address.
  -  [\#1551](https://github.com/DFWallet/anatha/issues/1551) Remove `--name` completely
...
* Gaia
  ...
  - [x/gov] [\#1781](https://github.com/DFWallet/anatha/issues/1781) Added tags sub-package, changed tags to use dash-case
  - [x/gov] [\#1688](https://github.com/DFWallet/anatha/issues/1688) Governance parameters are now stored in globalparams store
  - [x/gov] [\#1859](https://github.com/DFWallet/anatha/issues/1859) Slash validators who do not vote on a proposal
  - [x/gov] [\#1914](https://github.com/DFWallet/anatha/issues/1914) added TallyResult type that gets stored in Proposal after tallying is finished
...
* SDK
  ...
  - [client] [\#1551](https://github.com/DFWallet/anatha/issues/1551): Refactored `CoreContext` to `TxContext` and `QueryContext`
...
* Tendermint
    ...
    - v0.23.0 -> See
      ...
      and [SDK PR](https://github.com/DFWallet/anatha/pull/1927)
...
* Gaia CLI  (`gaiacli`)
    ...
    - [x/stake] [\#2043](https://github.com/DFWallet/anatha/issues/2043) Added staking query cli cmds for unbonding-delegations and redelegations
...
* SDK
  ...
  - [store] [\#1481](https://github.com/DFWallet/anatha/issues/1481) Add transient store
...
* Gaia
  - [spec] [\#967](https://github.com/DFWallet/anatha/issues/967) Inflation and distribution specs drastically improved
  - [x/gov] [\#1773](https://github.com/DFWallet/anatha/issues/1773) Votes on a proposal can now be queried
  - [x/gov] Initial governance parameters can now be set in the genesis file
  - [x/stake] [\#1815](https://github.com/DFWallet/anatha/issues/1815) Sped up the processing of `EditValidator` txs.
  - [config] [\#1930](https://github.com/DFWallet/anatha/issues/1930) Transactions indexer indexes all tags by default.
  - [ci] [#2057](https://github.com/DFWallet/anatha/pull/2057) Run `make localnet-start` on every commit and ensure network reaches at least 10 blocks

* SDK
  - [baseapp] [\#1587](https://github.com/DFWallet/anatha/issues/1587) Allow any alphanumeric character in route
  - [baseapp] Allow any alphanumeric character in route
  - [tools] Remove `rm -rf vendor/` from `make get_vendor_deps`
  - [x/auth] Recover ErrorOutOfGas panic in order to set sdk.Result attributes correctly
  - [x/auth] [\#2376](https://github.com/DFWallet/anatha/issues/2376) No longer runs any signature in a multi-msg, if any account/sequence number is wrong.
  - [x/auth] [\#2376](https://github.com/DFWallet/anatha/issues/2376) No longer charge gas for subtracting fees
  - [x/bank] Unit tests are now table-driven
  - [tests] Add tests to example apps in docs
  - [tests] Fixes ansible scripts to work with AWS too
  - [tests] [\#1806](https://github.com/DFWallet/anatha/issues/1806) CLI tests are now behind the build flag 'cli_test', so go test works on a new repo

BUG FIXES

* Gaia CLI  (`gaiacli`)
  -  [\#1766](https://github.com/DFWallet/anatha/issues/1766) Fixes bad example for keybase identity
  -  [x/stake] [\#2021](https://github.com/DFWallet/anatha/issues/2021) Fixed repeated CLI commands in staking

* Gaia
  - [x/stake] [#2077](https://github.com/DFWallet/anatha/pull/2077) Fixed invalid cliff power comparison
  - [\#1804](https://github.com/DFWallet/anatha/issues/1804) Fixes gen-tx genesis generation logic temporarily until upstream updates
  - [\#1799](https://github.com/DFWallet/anatha/issues/1799) Fix `gaiad export`
  - [\#1839](https://github.com/DFWallet/anatha/issues/1839) Fixed bug where intra-tx counter wasn't set correctly for genesis validators
  - [x/stake] [\#1858](https://github.com/DFWallet/anatha/issues/1858) Fixed bug where the cliff validator was not updated correctly
  - [tests] [\#1675](https://github.com/DFWallet/anatha/issues/1675) Fix non-deterministic `test_cover`
  - [tests] [\#1551](https://github.com/DFWallet/anatha/issues/1551) Fixed invalid LCD test JSON payload in `doIBCTransfer`
  - [basecoin] Fixes coin transaction failure and account query [discussion](https://forum.cosmos.network/t/unmarshalbinarybare-expected-to-read-prefix-bytes-75fbfab8-since-it-is-registered-concrete-but-got-0a141dfa/664/6)
  - [x/gov] [\#1757](https://github.com/DFWallet/anatha/issues/1757) Fix VoteOption conversion to String
...
*  [\#1797](https://github.com/DFWallet/anatha/issues/1797) Fix off-by-one error in slashing for downtime
*  [\#1787](https://github.com/DFWallet/anatha/issues/1787) Fixed bug where Tally fails due to revoked/unbonding validator
*  [\#1666](https://github.com/DFWallet/anatha/issues/1666) Add intra-tx counter to the genesis validators
...
BUG FIXES
* [\#1630](https://github.com/DFWallet/anatha/issues/1630) - redelegation nolonger removes tokens from the delegator liquid account
* [keys] [\#1629](https://github.com/DFWallet/anatha/issues/1629) - updating password no longer asks for a new password when the first entered password was incorrect
...
BUG FIXES
* [x/slashing] [\#1510](https://github.com/DFWallet/anatha/issues/1510) Unrevoked validators cannot un-revoke themselves
* [x/stake] [\#1513](https://github.com/DFWallet/anatha/issues/1513) Validators slashed to zero power are unbonded and removed from the store
* [x/stake] [\#1567](https://github.com/DFWallet/anatha/issues/1567) Validators decreased in power but not unbonded are now updated in Tendermint
...
* [\#872](https://github.com/DFWallet/anatha/issues/872)  - recovery phrases no longer all end in `abandon`
* [\#887](https://github.com/DFWallet/anatha/issues/887)  - limit the size of rationals that can be passed in from user input
* [\#1052](https://github.com/DFWallet/anatha/issues/1052) - Make all now works
* [\#1258](https://github.com/DFWallet/anatha/issues/1258) - printing big.rat's can no longer overflow int64
* [\#1259](https://github.com/DFWallet/anatha/issues/1259) - fix bug where certain tests that could have a nil pointer in defer
* [\#1343](https://github.com/DFWallet/anatha/issues/1343) - fixed unnecessary parallelism in CI
* [\#1353](https://github.com/DFWallet/anatha/issues/1353) - CLI: Show pool shares fractions in human-readable format
* [\#1367](https://github.com/DFWallet/anatha/issues/1367) - set ChainID in InitChain
* [\#1461](https://github.com/DFWallet/anatha/issues/1461) - CLI tests now no longer reset your local environment data
* [\#1505](https://github.com/DFWallet/anatha/issues/1505) - `gaiacli stake validator` no longer panics if validator doesn't exist
* [\#1565](https://github.com/DFWallet/anatha/issues/1565) - fix cliff validator persisting when validator set shrinks from max
* [\#1287](https://github.com/DFWallet/anatha/issues/1287) - prevent zero power validators at genesis
* [x/stake] fix bug when unbonding/redelegating using `--shares-percent`
* [\#1010](https://github.com/DFWallet/anatha/issues/1010) - two validators can't bond with the same pubkey anymore
...
FIXES
* Fixes consensus fault on testnet - see postmortem [here](https://github.com/DFWallet/anatha/issues/1197#issuecomment-396823021)
...
[Unreleased]: https://github.com/DFWallet/anatha/compare/v0.38.2...HEAD
[v0.38.2]: https://github.com/DFWallet/anatha/releases/tag/v0.38.2
[v0.38.1]: https://github.com/DFWallet/anatha/releases/tag/v0.38.1
[v0.38.0]: https://github.com/DFWallet/anatha/releases/tag/v0.38.0
[v0.37.6]: https://github.com/DFWallet/anatha/releases/tag/v0.37.6
[v0.37.5]: https://github.com/DFWallet/anatha/releases/tag/v0.37.5
[v0.37.4]: https://github.com/DFWallet/anatha/releases/tag/v0.37.4
[v0.37.3]: https://github.com/DFWallet/anatha/releases/tag/v0.37.3
[v0.37.1]: https://github.com/DFWallet/anatha/releases/tag/v0.37.1
[v0.37.0]: https://github.com/DFWallet/anatha/releases/tag/v0.37.0
[v0.36.0]: https://github.com/DFWallet/anatha/releases/tag/v0.36.0
