...
type MsgSetWithdrawAddress struct {
	...
	WithdrawAddress  github_com_cosmos_cosmos_sdk_types.AccAddress `protobuf:"bytes,2,opt,name=withdraw_address,json=withdrawAddress,proto3,casttype=github.com/DFWallet/anatha/types.AccAddress" json:"withdraw_address,omitempty" yaml:"withdraw_address"`
}
...
type MsgWithdrawValidatorCommission struct {
	ValidatorAddress github_com_cosmos_cosmos_sdk_types.ValAddress `protobuf:"bytes,1,opt,name=validator_address,json=validatorAddress,proto3,casttype=github.com/DFWallet/anatha/types.ValAddress" json:"validator_address,omitempty" yaml:"validator_address"`
}
...
type MsgFundCommunityPool struct {
	Amount    github_com_cosmos_cosmos_sdk_types.Coins      `protobuf:"bytes,1,rep,name=amount,proto3,castrepeated=github.com/DFWallet/anatha/types.Coins" json:"amount"`
	Depositor github_com_cosmos_cosmos_sdk_types.AccAddress `protobuf:"bytes,2,opt,name=depositor,proto3,casttype=github.com/DFWallet/anatha/types.AccAddress" json:"depositor,omitempty"`
}
...
type Params struct {
	CommunityTax        github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,1,opt,name=community_tax,json=communityTax,proto3,customtype=github.com/DFWallet/anatha/types.Dec" json:"community_tax" yaml:"community_tax"`
	BaseProposerReward  github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,2,opt,name=base_proposer_reward,json=baseProposerReward,proto3,customtype=github.com/DFWallet/anatha/types.Dec" json:"base_proposer_reward" yaml:"base_proposer_reward"`
	BonusProposerReward github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,3,opt,name=bonus_proposer_reward,json=bonusProposerReward,proto3,customtype=github.com/DFWallet/anatha/types.Dec" json:"bonus_proposer_reward" yaml:"bonus_proposer_reward"`
...
type ValidatorHistoricalRewards struct {
	CumulativeRewardRatio github_com_cosmos_cosmos_sdk_types.DecCoins `protobuf:"bytes,1,rep,name=cumulative_reward_ratio,json=cumulativeRewardRatio,proto3,castrepeated=github.com/DFWallet/anatha/types.DecCoins" json:"cumulative_reward_ratio" yaml:"cumulative_reward_ratio"`
...
type ValidatorCurrentRewards struct {
	Rewards github_com_cosmos_cosmos_sdk_types.DecCoins `protobuf:"bytes,1,rep,name=rewards,proto3,castrepeated=github.com/DFWallet/anatha/types.DecCoins" json:"rewards"`
...
type ValidatorAccumulatedCommission struct {
	Commission github_com_cosmos_cosmos_sdk_types.DecCoins `protobuf:"bytes,1,rep,name=commission,proto3,castrepeated=github.com/DFWallet/anatha/types.DecCoins" json:"commission"`
}
...
type ValidatorOutstandingRewards struct {
	Rewards github_com_cosmos_cosmos_sdk_types.DecCoins `protobuf:"bytes,1,rep,name=rewards,proto3,castrepeated=github.com/DFWallet/anatha/types.DecCoins" json:"rewards" yaml:"rewards"`
}
...
type ValidatorSlashEvent struct {
	...
	Fraction        github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,2,opt,name=fraction,proto3,customtype=github.com/DFWallet/anatha/types.Dec" json:"fraction"`
}
...
type FeePool struct {
	CommunityPool github_com_cosmos_cosmos_sdk_types.DecCoins `protobuf:"bytes,1,rep,name=community_pool,json=communityPool,proto3,castrepeated=github.com/DFWallet/anatha/types.DecCoins" json:"community_pool" yaml:"community_pool"`
}
...
type CommunityPoolSpendProposal struct {
	...
	Recipient   github_com_cosmos_cosmos_sdk_types.AccAddress `protobuf:"bytes,3,opt,name=recipient,proto3,casttype=github.com/DFWallet/anatha/types.AccAddress" json:"recipient,omitempty"`
	Amount      github_com_cosmos_cosmos_sdk_types.Coins      `protobuf:"bytes,4,rep,name=amount,proto3,castrepeated=github.com/DFWallet/anatha/types.Coins" json:"amount"`
}
...
type DelegatorStartingInfo struct {
	...
	Stake          github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,2,opt,name=stake,proto3,customtype=github.com/DFWallet/anatha/types.Dec" json:"stake" yaml:"stake"`
