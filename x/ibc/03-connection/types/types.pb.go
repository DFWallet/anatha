...
type MsgConnectionOpenTry struct {
	...
	Signer          github_com_cosmos_cosmos_sdk_types.AccAddress `protobuf:"bytes,9,opt,name=signer,proto3,casttype=github.com/DFWallet/anatha/types.AccAddress" json:"signer,omitempty"`
}
