...
type MsgUnjail struct {
	ValidatorAddr github_com_cosmos_cosmos_sdk_types.ValAddress `protobuf:"bytes,1,opt,name=validator_addr,json=validatorAddr,proto3,casttype=github.com/DFWallet/anatha/types.ValAddress" json:"address" yaml:"address"`
}
...
type ValidatorSigningInfo struct {
	Address github_com_cosmos_cosmos_sdk_types.ConsAddress `protobuf:"bytes,1,opt,name=address,proto3,casttype=github.com/DFWallet/anatha/types.ConsAddress" json:"address,omitempty"`
