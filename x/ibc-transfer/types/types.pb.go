...
type MsgTransfer struct {
	...
	// the sender address
	Sender github_com_cosmos_cosmos_sdk_types.AccAddress `protobuf:"bytes,5,opt,name=sender,proto3,casttype=github.com/DFWallet/anatha/types.AccAddress" json:"sender,omitempty"`
