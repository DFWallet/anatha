...
type MsgSubmitEvidence struct {
	Submitter github_com_cosmos_cosmos_sdk_types.AccAddress `protobuf:"bytes,1,opt,name=submitter,proto3,casttype=github.com/DFWallet/anatha/types.AccAddress" json:"submitter,omitempty"`
...
type Equivocation struct {
	...
	ConsensusAddress github_com_cosmos_cosmos_sdk_types.ConsAddress `protobuf:"bytes,4,opt,name=consensus_address,json=consensusAddress,proto3,casttype=github.com/DFWallet/anatha/types.ConsAddress" json:"consensus_address,omitempty" yaml:"consensus_address"`
}
