...
import (
	bytes "bytes"
	fmt "fmt"
	types "github.com/DFWallet/anatha/codec/types"
	github_com_cosmos_cosmos_sdk_types "github.com/DFWallet/anatha/types"
	types1 "github.com/DFWallet/anatha/types"
...
type MsgSubmitProposal struct {
	...
	InitialDeposit github_com_cosmos_cosmos_sdk_types.Coins      `protobuf:"bytes,2,rep,name=initial_deposit,json=initialDeposit,proto3,castrepeated=github.com/DFWallet/anatha/types.Coins" json:"initial_deposit" yaml:"initial_deposit"`
	Proposer       github_com_cosmos_cosmos_sdk_types.AccAddress `protobuf:"bytes,3,opt,name=proposer,proto3,casttype=github.com/DFWallet/anatha/types.AccAddress" json:"proposer,omitempty"`
}
...
type MsgVote struct {
	...
	Voter      github_com_cosmos_cosmos_sdk_types.AccAddress `protobuf:"bytes,2,opt,name=voter,proto3,casttype=github.com/DFWallet/anatha/types.AccAddress" json:"voter,omitempty"`
...
type MsgDeposit struct {
	...
	Amount     github_com_cosmos_cosmos_sdk_types.Coins      `protobuf:"bytes,3,rep,name=amount,proto3,castrepeated=github.com/DFWallet/anatha/types.Coins" json:"amount"`
}
...
type Proposal struct {
	...
	TotalDeposit     github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,7,rep,name=total_deposit,json=totalDeposit,proto3,castrepeated=github.com/DFWallet/anatha/types.Coins" json:"total_deposit" yaml:"total_deposit"`
...
type TallyResult struct {
	Yes        github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,1,opt,name=yes,proto3,customtype=github.com/DFWallet/anatha/types.Int" json:"yes"`
	Abstain    github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,2,opt,name=abstain,proto3,customtype=github.com/DFWallet/anatha/types.Int" json:"abstain"`
	No         github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,3,opt,name=no,proto3,customtype=github.com/DFWallet/anatha/types.Int" json:"no"`
	NoWithVeto github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,4,opt,name=no_with_veto,json=noWithVeto,proto3,customtype=github.com/DFWallet/anatha/types.Int" json:"no_with_veto" yaml:"no_with_veto"`
}
