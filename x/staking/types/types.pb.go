...
import (
	bytes "bytes"
	fmt "fmt"
	github_com_cosmos_cosmos_sdk_types "github.com/DFWallet/anatha/types"
	types "github.com/DFWallet/anatha/types"
...
type MsgCreateValidator struct {
	...
	MinSelfDelegation github_com_cosmos_cosmos_sdk_types.Int        `protobuf:"bytes,3,opt,name=min_self_delegation,json=minSelfDelegation,proto3,customtype=github.com/DFWallet/anatha/types.Int" json:"min_self_delegation" yaml:"min_self_delegation"`
	DelegatorAddress  github_com_cosmos_cosmos_sdk_types.AccAddress `protobuf:"bytes,4,opt,name=delegator_address,json=delegatorAddress,proto3,casttype=github.com/DFWallet/anatha/types.AccAddress" json:"delegator_address,omitempty" yaml:"delegator_address"`
	ValidatorAddress  github_com_cosmos_cosmos_sdk_types.ValAddress `protobuf:"bytes,5,opt,name=validator_address,json=validatorAddress,proto3,casttype=github.com/DFWallet/anatha/types.ValAddress" json:"validator_address,omitempty" yaml:"validator_address"`
...
type MsgEditValidator struct {
	Description      Description                                   `protobuf:"bytes,1,opt,name=description,proto3" json:"description"`
	ValidatorAddress github_com_cosmos_cosmos_sdk_types.ValAddress `protobuf:"bytes,2,opt,name=validator_address,json=validatorAddress,proto3,casttype=github.com/DFWallet/anatha/types.ValAddress" json:"validator_address,omitempty" yaml:"address"`
	// We pass a reference to the new commission rate and min self delegation as
	// it's not mandatory to update. If not updated, the deserialized rate will be
	// zero with no way to distinguish if an update was intended.
	//
	// REF: #2373
	CommissionRate    *github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,3,opt,name=commission_rate,json=commissionRate,proto3,customtype=github.com/DFWallet/anatha/types.Dec" json:"commission_rate,omitempty" yaml:"commission_rate"`
	MinSelfDelegation *github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,4,opt,name=min_self_delegation,json=minSelfDelegation,proto3,customtype=github.com/DFWallet/anatha/types.Int" json:"min_self_delegation,omitempty" yaml:"min_self_delegation"`
}
...
type MsgDelegate struct {
	DelegatorAddress github_com_cosmos_cosmos_sdk_types.AccAddress `protobuf:"bytes,1,opt,name=delegator_address,json=delegatorAddress,proto3,casttype=github.com/DFWallet/anatha/types.AccAddress" json:"delegator_address,omitempty" yaml:"delegator_address"`
	ValidatorAddress github_com_cosmos_cosmos_sdk_types.ValAddress `protobuf:"bytes,2,opt,name=validator_address,json=validatorAddress,proto3,casttype=github.com/DFWallet/anatha/types.ValAddress" json:"validator_address,omitempty" yaml:"validator_address"`
...
type MsgBeginRedelegate struct {
	DelegatorAddress    github_com_cosmos_cosmos_sdk_types.AccAddress `protobuf:"bytes,1,opt,name=delegator_address,json=delegatorAddress,proto3,casttype=github.com/DFWallet/anatha/types.AccAddress" json:"delegator_address,omitempty" yaml:"delegator_address"`
	ValidatorSrcAddress github_com_cosmos_cosmos_sdk_types.ValAddress `protobuf:"bytes,2,opt,name=validator_src_address,json=validatorSrcAddress,proto3,casttype=github.com/DFWallet/anatha/types.ValAddress" json:"validator_src_address,omitempty" yaml:"validator_src_address"`
	ValidatorDstAddress github_com_cosmos_cosmos_sdk_types.ValAddress `protobuf:"bytes,3,opt,name=validator_dst_address,json=validatorDstAddress,proto3,casttype=github.com/DFWallet/anatha/types.ValAddress" json:"validator_dst_address,omitempty" yaml:"validator_dst_address"`
...
type CommissionRates struct {
	Rate          github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,1,opt,name=rate,proto3,customtype=github.com/DFWallet/anatha/types.Dec" json:"rate"`
	MaxRate       github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,2,opt,name=max_rate,json=maxRate,proto3,customtype=github.com/DFWallet/anatha/types.Dec" json:"max_rate" yaml:"max_rate"`
	MaxChangeRate github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,3,opt,name=max_change_rate,json=maxChangeRate,proto3,customtype=github.com/DFWallet/anatha/types.Dec" json:"max_change_rate" yaml:"max_change_rate"`
}
...
type Validator struct {
	OperatorAddress   github_com_cosmos_cosmos_sdk_types.ValAddress `protobuf:"bytes,1,opt,name=operator_address,json=operatorAddress,proto3,casttype=github.com/DFWallet/anatha/types.ValAddress" json:"operator_address,omitempty" yaml:"operator_address"`
	...
	Status            github_com_cosmos_cosmos_sdk_types.BondStatus `protobuf:"varint,4,opt,name=status,proto3,casttype=github.com/DFWallet/anatha/types.BondStatus" json:"status,omitempty"`
	Tokens            github_com_cosmos_cosmos_sdk_types.Int        `protobuf:"bytes,5,opt,name=tokens,proto3,customtype=github.com/DFWallet/anatha/types.Int" json:"tokens"`
	DelegatorShares   github_com_cosmos_cosmos_sdk_types.Dec        `protobuf:"bytes,6,opt,name=delegator_shares,json=delegatorShares,proto3,customtype=github.com/DFWallet/anatha/types.Dec" json:"delegator_shares" yaml:"delegator_shares"`
	...
	MinSelfDelegation github_com_cosmos_cosmos_sdk_types.Int        `protobuf:"bytes,11,opt,name=min_self_delegation,json=minSelfDelegation,proto3,customtype=github.com/DFWallet/anatha/types.Int" json:"min_self_delegation" yaml:"min_self_delegation"`
}
...
type Delegation struct {
	DelegatorAddress github_com_cosmos_cosmos_sdk_types.AccAddress `protobuf:"bytes,1,opt,name=delegator_address,json=delegatorAddress,proto3,casttype=github.com/DFWallet/anatha/types.AccAddress" json:"delegator_address,omitempty" yaml:"delegator_address"`
	ValidatorAddress github_com_cosmos_cosmos_sdk_types.ValAddress `protobuf:"bytes,2,opt,name=validator_address,json=validatorAddress,proto3,casttype=github.com/DFWallet/anatha/types.ValAddress" json:"validator_address,omitempty" yaml:"validator_address"`
	Shares           github_com_cosmos_cosmos_sdk_types.Dec        `protobuf:"bytes,3,opt,name=shares,proto3,customtype=github.com/DFWallet/anatha/types.Dec" json:"shares"`
}
...
type UnbondingDelegationEntry struct {
	...
	InitialBalance github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,3,opt,name=initial_balance,json=initialBalance,proto3,customtype=github.com/DFWallet/anatha/types.Int" json:"initial_balance" yaml:"initial_balance"`
	Balance        github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,4,opt,name=balance,proto3,customtype=github.com/DFWallet/anatha/types.Int" json:"balance"`
}
...
type RedelegationEntry struct {
	...
	CompletionTime time.Time                              `protobuf:"bytes,2,opt,name=completion_time,json=completionTime,proto3,stdtime" json:"completion_time" yaml:"completion_time"`
	InitialBalance github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,3,opt,name=initial_balance,json=initialBalance,proto3,customtype=github.com/DFWallet/anatha/types.Int" json:"initial_balance" yaml:"initial_balance"`
	SharesDst      github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,4,opt,name=shares_dst,json=sharesDst,proto3,customtype=github.com/DFWallet/anatha/types.Dec" json:"shares_dst"`
}
