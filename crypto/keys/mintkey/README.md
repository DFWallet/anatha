...
```bash
go test -v --bench github.com/DFWallet/anatha/crypto/keys/mintkey
```
...
goos: linux
goarch: amd64
pkg: github.com/DFWallet/anatha/crypto/keys/mintkey
...
PASS
ok  	github.com/DFWallet/anatha/crypto/keys/mintkey	12.093s
```
