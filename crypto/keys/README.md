...
[![API Reference](https://godoc.org/github.com/DFWallet/anatha/crypto/keys?status.svg)](https://godoc.org/github.com/DFWallet/anatha/crypto/keys)


## The Keybase interface

The [Keybase](https://godoc.org/github.com/DFWallet/anatha/crypto/keys#Keybase) interface defines
...
The [New](https://godoc.org/github.com/DFWallet/anatha/crypto/keys#New) constructor returns
...
Due to [security concerns](https://github.com/DFWallet/anatha/blob/master/docs/architecture/adr-006-secret-store-replacement.md), we recommend to drop
...
The [NewInMemory](https://godoc.org/github.com/DFWallet/anatha/crypto/keys#NewInMemory) constructor returns
...
The [NewKeyring](https://godoc.org/github.com/DFWallet/anatha/crypto/keys#NewKeyring) constructor returns
...
Both [NewKeyringFile](https://godoc.org/github.com/DFWallet/anatha/crypto/keys#NewKeyringFile) and
[NewTestKeyring](https://godoc.org/github.com/DFWallet/anatha/crypto/keys#NewTestKeyring) constructors return
