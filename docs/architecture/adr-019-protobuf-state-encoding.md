...
After [extension discussion](https://github.com/DFWallet/anatha/issues/6030),
...
message MsgSubmitEvidence {
  bytes submitter = 1
    [
      (gogoproto.casttype) = "github.com/DFWallet/anatha/types.AccAddress"
    ];
...
1. https://github.com/DFWallet/anatha/issues/4977
2. https://github.com/DFWallet/anatha/issues/5444
