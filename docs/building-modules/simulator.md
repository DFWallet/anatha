...
You can use the example [here](https://github.com/DFWallet/anatha/blob/release%2Fv0.38.0/x/distribution/simulation/decoder.go) from the distribution module to implement your store decoders.
...
You can check an example on how to create the randomized genesis [here](https://github.com/DFWallet/anatha/blob/release%2Fv0.38.0/x/staking/simulation/genesis.go).
...
You can see how an example of what is needed to fully test parameter changes [here](https://github.com/DFWallet/anatha/blob/release%2Fv0.38.0/x/staking/simulation/params.go)
...
+++ https://github.com/DFWallet/anatha/blob/release%2Fv0.38.0/x/staking/simulation/operations.go#L18-L92
...
+++ https://github.com/DFWallet/anatha/blob/release%2Fv0.38.0/x/distribution/module.go#L156-L185
