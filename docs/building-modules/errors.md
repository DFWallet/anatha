...
+++ https://github.com/DFWallet/anatha/blob/v0.38.1/x/distribution/types/errors.go#L1-L21
...
+++ https://github.com/DFWallet/anatha/blob/v0.38.1/x/distribution/keeper/querier.go#L62-L80
