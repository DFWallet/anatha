...
If you want to open a PR on the Cosmos SDK to update the documentation, please follow the guidelines in the [`CONTRIBUTING.md`](https://github.com/DFWallet/anatha/tree/master/CONTRIBUTING.md#updating-documentation)
...
[master](https://github.com/DFWallet/anatha/tree/master/docs).
...
Then, edit the `swagger.yaml` manually; it is found [here](https://github.com/DFWallet/anatha/blob/master/client/lcd/swagger-ui/swagger.yaml)
