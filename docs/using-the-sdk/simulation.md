...
This functionality is provided by the[`SimApp`](https://github.com/DFWallet/anatha/blob/master/simapp/app.go),
which is a dummy application that is used for running the [`simulation`](https://github.com/DFWallet/anatha/tree/master/x/simulation) module.
...
Check the full list of flags [here](https://github.com/DFWallet/anatha/blob/adf6ddd4a807c8363e33083a3281f6a5e112ab89/simapp/sim_test.go#L34-L50).
...
This allows for a more controlled and deterministic simulation setup while allowing the state space to still be pseudo-randomly simulated. The list of available parameters is listed [here](https://github.com/DFWallet/anatha/blob/adf6ddd4a807c8363e33083a3281f6a5e112ab89/x/simulation/params.go#L170-L178).
...
This is a general example of how simulations are run. For more specific examples check the SDK [Makefile](https://github.com/DFWallet/anatha/blob/adf6ddd4a807c8363e33083a3281f6a5e112ab89/Makefile#L88-L123).
...
- Try adding logs to operations that are not logged. You will have to define a [Logger](https://github.com/DFWallet/anatha/blob/adf6ddd4a807c8363e33083a3281f6a5e112ab89/x/staking/keeper/keeper.go#L65:17) on your `Keeper`.
