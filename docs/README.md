...
- **[SDK API Reference](https://godoc.org/github.com/DFWallet/anatha)**: Godocs of the Cosmos SDK.
...
See [this file](https://github.com/DFWallet/anatha/blob/master/docs/DOCS_README.md) for details of the build process and
