...
+++ https://github.com/DFWallet/anatha/blob/7d7821b9af132b0f6131640195326aa02b6751db/baseapp/baseapp.go#L54-L108
...
- [`TxDecoder`](https://godoc.org/github.com/DFWallet/anatha/types#TxDecoder): It is used to decode
...
possibility to provide additional [`options`](https://github.com/DFWallet/anatha/blob/7d7821b9af132b0f6131640195326aa02b6751db/baseapp/options.go)
...
The [default router included in baseapp](https://github.com/DFWallet/anatha/blob/master/baseapp/router.go) is stateless.  However, some applications may want to make use of more stateful routing mechanisms such as allowing governance to disable certain routes or point them to new modules for upgrade purposes.  For this reason, the `sdk.Context` is also passed into the `Route` function of the [Router interface](https://github.com/DFWallet/anatha/blob/master/types/router.go#L12).  For a stateless router that doesn't want to make use of this, can just ignore the ctx.
...
- `GasUsed (int64)`: Amount of gas consumed by transaction. During `CheckTx`, this value is computed by multiplying the standard cost of a transaction byte by the size of the raw transaction. Next is an example:
  +++ https://github.com/DFWallet/anatha/blob/7d7821b9af132b0f6131640195326aa02b6751db/x/auth/ante/basic.go#L104
...
+++ https://github.com/DFWallet/anatha/blob/7d7821b9af132b0f6131640195326aa02b6751db/store/types/gas.go#L142-L150
...
+++ https://github.com/DFWallet/anatha/blob/7d7821b9af132b0f6131640195326aa02b6751db/baseapp/baseapp.go#L587
...
+++ https://github.com/DFWallet/anatha/blob/7d7821b9af132b0f6131640195326aa02b6751db/types/handler.go#L8
...
`baseapp` holds an `anteHandler` as paraemter, which is initialized in the [application's constructor](../basics/app-anatomy.md#application-constructor). The most widely used `anteHandler` today is that of the [`auth` module](https://github.com/DFWallet/anatha/blob/master/x/auth/ante/ante.go).
...
- Initialize [`deliverState`](#volatile-states) with the latest header using the `req abci.RequestBeginBlock` passed as parameter via the `setDeliverState` function. 
  +++ https://github.com/DFWallet/anatha/blob/7d7821b9af132b0f6131640195326aa02b6751db/baseapp/baseapp.go#L387-L397
