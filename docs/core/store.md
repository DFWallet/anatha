...
+++ https://github.com/DFWallet/anatha/blob/7d7821b9af132b0f6131640195326aa02b6751db/store/types/store.go#L12-L15
...
+++ https://github.com/DFWallet/anatha/blob/7d7821b9af132b0f6131640195326aa02b6751db/store/types/store.go#L217-L238
...
+++ https://github.com/DFWallet/anatha/blob/7d7821b9af132b0f6131640195326aa02b6751db/store/types/store.go#L24-L28

The `Committer` is an interface that defines methods to persist changes to disk:

+++ https://github.com/DFWallet/anatha/blob/7d7821b9af132b0f6131640195326aa02b6751db/store/types/store.go#L17-L22
...
+++ https://github.com/DFWallet/anatha/blob/7d7821b9af132b0f6131640195326aa02b6751db/store/types/store.go#L83-L112
...
+++ https://github.com/DFWallet/anatha/blob/7d7821b9af132b0f6131640195326aa02b6751db/store/types/store.go#L120-L158

As for concrete implementation, the [`rootMulti.Store`] is the go-to implementation of the `CommitMultiStore` interface. 

+++ https://github.com/DFWallet/anatha/blob/7d7821b9af132b0f6131640195326aa02b6751db/store/rootmulti/store.go#L27-L43
...
Whenever the `rootMulti.Store` needs to be cached-wrapped, a [`cachemulti.Store`](https://github.com/DFWallet/anatha/blob/master/store/cachemulti/store.go) is used. 

+++ https://github.com/DFWallet/anatha/blob/7d7821b9af132b0f6131640195326aa02b6751db/store/cachemulti/store.go#L17-L28
...
+++ https://github.com/DFWallet/anatha/blob/7d7821b9af132b0f6131640195326aa02b6751db/store/types/store.go#L163-L193
...
+++ https://github.com/DFWallet/anatha/blob/7d7821b9af132b0f6131640195326aa02b6751db/store/iavl/store.go#L32-L47
...
+++ https://github.com/DFWallet/anatha/blob/7d7821b9af132b0f6131640195326aa02b6751db/store/dbadapter/store.go#L13-L16
...
+++ https://github.com/DFWallet/anatha/blob/7d7821b9af132b0f6131640195326aa02b6751db/store/transient/store.go#L14-L17
...
+++ https://github.com/DFWallet/anatha/blob/7d7821b9af132b0f6131640195326aa02b6751db/x/params/subspace/subspace.go#L24-L32

Transient stores are typically accessed via the [`context`](./context.md) via the `TransientStore()` method:

+++ https://github.com/DFWallet/anatha/blob/7d7821b9af132b0f6131640195326aa02b6751db/types/context.go#L215-L218
...
+++ https://github.com/DFWallet/anatha/blob/7d7821b9af132b0f6131640195326aa02b6751db/store/cachekv/store.go#L26-L33
...
Cosmos SDK applications use [`gas`](../basics/gas-fees.md) to track resources usage and prevent spam. [`GasKv.Store`](https://github.com/DFWallet/anatha/blob/master/store/gaskv/store.go) is a `KVStore` wrapper that enables automatic gas consumption each time a read or write to the store is made. It is the solution of choice to track storage usage in Cosmos SDK applications.

+++ https://github.com/DFWallet/anatha/blob/7d7821b9af132b0f6131640195326aa02b6751db/store/gaskv/store.go#L11-L17
...
+++ https://github.com/DFWallet/anatha/blob/7d7821b9af132b0f6131640195326aa02b6751db/store/types/gas.go#L141-L150
...
+++ https://github.com/DFWallet/anatha/blob/7d7821b9af132b0f6131640195326aa02b6751db/types/context.go#L210-L213

In this case, the default gas configuration is used:

+++ https://github.com/DFWallet/anatha/blob/7d7821b9af132b0f6131640195326aa02b6751db/store/types/gas.go#L152-L163
...
+++ https://github.com/DFWallet/anatha/blob/7d7821b9af132b0f6131640195326aa02b6751db/store/tracekv/store.go#L20-L43
...
+++ https://github.com/DFWallet/anatha/blob/7d7821b9af132b0f6131640195326aa02b6751db/store/prefix/store.go#L17-L20
